...
class ApiConfig {
  // Active environment (Defaults to production public domain)
  ...
  static const String _localAdbUrl = 'http://127.0.0.1:8000/api/v1';
  static const String _emulatorUrl = 'http://10.0.2.2:8000/api/v1';
  static const String _stagingUrl = 'https://ashwash-staging.up.railway.app/api/v1';
  static const String _prodUrl = 'https://ashwash-backend.onrender.com/api/v1';
